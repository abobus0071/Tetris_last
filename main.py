...
# Images
imgb = pygame.image.load('pic/1.png')
imgg = pygame.image.load('pic/2.png')
imgp = pygame.image.load('pic/3.png')
imgr = pygame.image.load('pic/4.png')
...
# FONTS
font = pygame.font.Font('font/Alternity-8w7J.ttf', 50)
...
move_down = False
can_move = True
start_screen_img = pygame.image.load('pic/Tetris.jfif')
